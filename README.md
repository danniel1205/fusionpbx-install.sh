...
Fast++ only maintains Debian installation at this moment.
...
```sh
wget -O - https://raw.githubusercontent.com/danniel1205/fusionpbx-install.sh/master/debian/pre-install.sh | sh;
